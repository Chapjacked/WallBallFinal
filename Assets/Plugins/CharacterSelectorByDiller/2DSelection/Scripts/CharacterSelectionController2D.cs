...
public class CharacterSelectionController2D : MonoBehaviour {
	...
	//For controlling the movement direction of the camera
	...
	private string savedIndexPlayerPrefs = "SelectedIndex2D";
	...
	void Start ()
	{
		...
		//Get the last index selected as this will be the starting point
